...
<img src="https://cdn.jsdelivr.net/gh/BigHuang66/picBed@main/img/20210407184133.png" alt="image-20210407184133143" style="zoom:67%;" />

序列化：使用 `#` 代表 空指针 nullptr , `( )`  表示子树的划分
...
[191. 位1的个数 - 力扣（LeetCode） (leetcode-cn.com)](https://leetcode-cn.com/problems/number-of-1-bits/)
...
[231. 2的幂 - 力扣（LeetCode） (leetcode-cn.com)](https://leetcode-cn.com/problems/power-of-two/)
...
找到链表中间节点可以参考 Leetcode 816题，此处有一点不同的是，不同于数组的归并，找到mid位置后可以使用索引进行分段处理，链表必须实实在在的将其分成两部分，故 mid 作为第二条链的头指针，同时需要维护将第一条链的末尾置为nullptr。
